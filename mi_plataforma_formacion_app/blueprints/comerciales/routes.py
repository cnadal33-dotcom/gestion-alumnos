...
def gestion_comerciales():
    ...
    # Prepare a mapping of comercial.id -> list of empresas dicts so template can safely tojson()
    empresas_data = {}
    ...
    return render_template('comerciales/gestion_comerciales.html', comerciales=comerciales, empresas_data=empresas_data)
